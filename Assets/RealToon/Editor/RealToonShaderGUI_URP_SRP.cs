...
public class RealToonShaderGUI_URP_SRP : ShaderGUI
{
    ...
    static void ChanLi(string searchTXT, string TXTChange, string fileName)
    {
        ...
        {
            Debug.Log("Can't do operation remove/add outline because '" + fileName + "' Does not exist or file not found, ");
        }
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        if (GUILayout.Button(new GUIContent("[" + remooutstat + " (On Shader)]", TOTIPS[135]), "Toolbar"))
            ...
            if (remoout == true)
            {
                ...
                ChanLi("Tags{}", "Tags{" + (char)34 + "LightMode" + (char)34 + "=" + (char)34 + "remove" + (char)34 + "}", "Assets/RealToon/RealToon Shaders/Version 5/URP/Default/D_Fade_Transparency_URP.shader");
                ...
                AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/URP/Default/D_Fade_Transparency_URP.shader");
                Debug.Log("Outline feature removed on RealToon URP shaders.");
            }
            else if (remoout == false)
            {
                ...
                ChanLi("Tags{" + (char)34 + "LightMode" + (char)34 + "=" + (char)34 + "remove" + (char)34 + "}", "Tags{}", "Assets/RealToon/RealToon Shaders/Version 5/URP/Default/D_Fade_Transparency_URP.shader");
                remooutstat = "Remove Outline";
                remoout = true;
                AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                AssetDatabase.ImportAsset("Assets/RealToon/RealToon Shaders/Version 5/URP/Default/D_Fade_Transparency_URP.shader");
                Debug.Log("Outline feature added on RealToon URP shaders.");
            }
