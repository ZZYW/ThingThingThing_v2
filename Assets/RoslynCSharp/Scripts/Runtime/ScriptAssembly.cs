...
namespace RoslynCSharp
{
    ...
    /// </summary>
    public class ScriptAssembly : IMetadataReferenceProvider
    {
        // Private
        ...
        // Constructor
        protected ScriptAssembly()//ScriptDomain domain, Assembly rawAssembly, CompilationResult compileResult = null)
        {
            //this.domain = domain;
        ...
        private void BuildAssembly()
        {
            ...
            foreach (Type type in rawTypes)
            {
                ...
                {
                    // Create a root type
                    ScriptType asmType = BuildScriptType(this, null, type);
        ...
        private void CreateNestedTypes(ScriptType type)
        {
            ...
            foreach (Type nestedType in nestedTypes)
            {
                ...
                ScriptType nestedScriptType = BuildScriptType(this, type, nestedType);
        ...
        public static ScriptAssembly CreateAssembly(ScriptDomain domain, CompilationResult result, Assembly rawAssembly = null)
        {
            // Check for success
            if (result.Success == false)
                return null;
