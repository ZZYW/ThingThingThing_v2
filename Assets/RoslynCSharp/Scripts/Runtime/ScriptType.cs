...
namespace RoslynCSharp
{
    ...
    public class ScriptType
    {
        ...
        protected internal ScriptType(ScriptAssembly assembly, ScriptType parent, Type type)
        {
            ...
            for (int i = 0; i < nested.Length; i++)
                this.nestedTypes[i] = assembly.BuildScriptType(assembly, this, nested[i]);
        }
        ...
        /// <returns>An instance of <see cref="ScriptProxy"/></returns>
        public virtual ScriptProxy CreateInstance(GameObject parent = null, params object[] parameters)
        {
            if (IsMonoBehaviour == true)
            {
                // Create a component instance
        ...
        protected virtual ScriptProxy CreateBehaviourInstance(GameObject parent)
        {
        ...
        protected virtual ScriptProxy CreateScriptableInstance()
        {
        ...
        protected virtual ScriptProxy CreateCSharpInstance(params object[] args)
        {
